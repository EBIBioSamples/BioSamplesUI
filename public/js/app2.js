...
},{"../compiler":21,"../util":72,"_process":1}],17:[function(require,module,exports){
(function (process){
var _ = require('./util')
var config = require('./config')
...
},{"./config":23,"./util":72,"_process":1}],18:[function(require,module,exports){
/**
...
},{"../config":23,"../directives/prop":39,"../parsers/path":62,"../parsers/text":64,"../util":72,"_process":1}],20:[function(require,module,exports){
(function (process){
var _ = require('../util')
...
},{"../config":23,"../directives/component":28,"../parsers/directive":60,"../parsers/template":63,"../parsers/text":64,"../util":72,"./compile-props":19,"_process":1}],21:[function(require,module,exports){
var _ = require('../util')
...
},{"../config":23,"../parsers/template":63,"../util":72,"_process":1}],23:[function(require,module,exports){
module.exports = {
...
},{"./config":23,"./parsers/expression":61,"./parsers/text":64,"./util":72,"./watcher":76,"_process":1}],25:[function(require,module,exports){
// xlink
...
},{"../config":23,"../parsers/template":63,"../util":72,"_process":1}],29:[function(require,module,exports){
module.exports = {
...
},{"../cache":18,"../compiler":21,"../parsers/template":63,"../transition":65,"../util":72,"_process":1}],32:[function(require,module,exports){
...
},{"../../util":72,"./checkbox":33,"./radio":35,"./select":36,"./text":37,"_process":1}],35:[function(require,module,exports){
var _ = require('../../util')
...
},{"../../parsers/directive":60,"../../util":72,"../../watcher":76,"_process":1}],37:[function(require,module,exports){
var _ = require('../../util')
...
},{"../util":72,"_process":1}],39:[function(require,module,exports){
...
},{"../util":72,"_process":1}],41:[function(require,module,exports){
(function (process){
var _ = require('../util')
var config = require('../config')
...
},{"../compiler":21,"../config":23,"../parsers/expression":61,"../parsers/template":63,"../parsers/text":64,"../util":72,"_process":1}],42:[function(require,module,exports){
var transition = require('../transition')
...
},{"../cache":18,"../compiler":21,"../directives/if":31,"../parsers/template":63,"../parsers/text":64,"../util":72,"_process":1}],49:[function(require,module,exports){
var _ = require('../util')
var Path = require('../parsers/path')
...
},{"../util":72,"_process":1}],55:[function(require,module,exports){
(function (process){
var _ = require('../util')
var compiler = require('../compiler')
...
},{"../compiler":21,"../observer":58,"../observer/dep":57,"../util":72,"../watcher":76,"_process":1}],56:[function(require,module,exports){
var _ = require('../util')
...
},{"../cache":18,"../util":72,"./path":62,"_process":1}],62:[function(require,module,exports){
(function (process){
var _ = require('../util')
var Cache = require('../cache')
...
},{"../cache":18,"../util":72,"_process":1}],63:[function(require,module,exports){
var _ = require('../util')
var Cache = require('../cache')
...
},{"../config":23,"_process":1}],70:[function(require,module,exports){
(function (process){
var _ = require('./index')
var config = require('../config')
...
},{"../config":23,"./index":72,"_process":1}],71:[function(require,module,exports){
...
},{"../config":23,"./index":72,"_process":1}],75:[function(require,module,exports){
var _ = require('./util')
var extend = _.extend
...
},{"./batcher":17,"./config":23,"./observer/dep":57,"./parsers/expression":61,"./util":72,"_process":1}],77:[function(require,module,exports){
'use strict';

(function () {
	var Biosample = function Biosample(id, type, description, release) {
		var biosample = {};
...
new Vue({
	...
	methods: {
		querySamples: function querySamples(e) {
			...
			this.$http.get(server, queryParams).success(function (results) {
...
},{"./Biosample.js":77,"./components/productsList/ProductsList.js":83,"./components/productsTable/ProductsTable.js":85,"./views/table.js":87,"underscore":2,"vue":75,"vue-resource":4}],79:[function(require,module,exports){
'use strict';
...
module.exports = {
	template: require('./pagination-2.template.html'),
...
},{"./products.table.template.html":86,"underscore":2}],86:[function(require,module,exports){
module.exports = '<div class="row">\n    <table class="table">\n        <thead>\n            <tr>\n                <th v-repeat="column: _columns">\n                    <a href="#" v-on="click: sortBy(column)"\n                    v-class="active: sortKey == column"\n                    >{{column | capitalize}}</a>\n                    <div class="triangle triangle-down"\n                    v-class="active: sortKey == column && ! reverseSort"></div>\n                    <div class="triangle triangle-up"\n                    v-class="active: sortKey == column && reverseSort"></div>\n                </th>\n            </tr>\n        </thead>\n        <tbody>\n            <tr v-repeat="elements | filterBy filterTerm | orderBy sortKey reverseSort">\n                <td>{{getTitle()}}</td>\n                <td>{{getType()}}</td>\n                <td>{{getDescription()}}</td>\n                <td>{{getReleaseDate()}}</td>\n            </tr>\n        </tbody>\n    </table>\n</div>';
...
},{"../components/itemsDropdown/ItemsDropdown.js":79,"../components/pagination/Pagination.js":81,"./table.template.html":88,"underscore":2}],88:[function(require,module,exports){
module.exports = '<div class="row">\n    <div class="form-group col-md-8">\n        <input type="text" name="searchTerm" id="inputSearchTerm" class="form-control" value="" placeholder="Filter results..." v-model="filterTerm">\n    </div>\n\n    <div class="col-md-2">\n        <pagination total-results="{{totalResults}}"\n                    displayed-results="{{displayedResults}}"\n                    style="float:right">\n        </pagination>\n    </div>\n    <div class="col-md-2">\n        <items-dropdown choices="{{availableItemsPerPage}}"\n                    text-filler="Items per page: "\n                    style="float:right">\n        </items-dropdown>    \n    </div>\n</div>';
},{}]},{},[78]);
